...
public class Query3Depth1Mapper implements KeyValueMapper<String, Comment, KeyValue<Windowed<Long>, byte[]>> {
	...
	public Query3Depth1Mapper(Double approvedInc, Jedis jedis, String redisRoot, ObjectMapper mapper) {
